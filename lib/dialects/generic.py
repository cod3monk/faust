...
class Router(object):
    ...
    def _connect(self, hostname, username, password, port=22, read_running_config_first=True):
        """Sets basic information necessasery to connect to router and
        connects."""

        raise Exception("execute method was not implemented in router dialect")
    ...
    def check_acl_name(self, name):
        ...
        raise Exception("check_acl_name method was not implemented in router dialect")
    ...
    def read_acl(self, name, ip='ipv4'):
        ...
        raise Exception("read_acl method was not implemented in router dialect")
    ...
    def write_acl(self, name, rules, ip='ipv4'):
        ...
        raise Exception("write_acl method was not implemented in router dialect")
    ...
    def remove_acl(self, name, ip='ipv4'):
        ...
        raise Exception("remove_acl method was not implemented in router dialect")
    ...
    def get_bound_acl_form_interface(self, interface):
        ...
        raise Exception("get_bound_acl_form_interface method was not implemented in router dialect")
    ...
    def bind_acl_to_interface(self, interface, acl_name_in, acl_name_out, ip='ipv4'):
        ...
        raise Exception("bind_acl_to_interface method was not implemented in router dialect")
    ...
    def unbind_acl_from_interface(self, interface):
        ...
        raise Exception("unbind_acl_from_interface method was not implemented in router dialect")

    def close(self):
        raise Exception("OMG!! We'are all gonna die! (close method was not implemented in router " +
                        "dialect and is of utter importance. Please do so!")
